...
describe("MainPage", () => {
  ...
  let exame: Exame
  let state: WritableSignal<ExameState>
  ...
  it("should initialize with correct values", () => {
    ...
    expect(state().message).toBe("Receber material na secretaria do SETEC")
    expect(state().action).toBe(TAREFAS.RECEBER_MATERIAL)
    expect(state().status).toBe(STEP.RECEBER_MATERIAL)
    expect(state().listaExames).toEqual([])
    expect(state().usuarioAtual).toEqual(authServiceMock.getUsuarioAtual())
    expect(state().exameAtual).toBeNull()
  })

  it("should create exame when calling getExame if not exists", () => {
    const material = new Material("0123/2024")
    expect(state().listaExames.length).toBe(0)
    const exame = component.getExame(material)
    expect(exame).toBeDefined()
    expect(exame.material).toEqual(material)
    expect(state().listaExames.length).toBe(1)
    expect(state().exameAtual.material).toEqual(material)
  ...
  it("should return the correct exame when calling getExame", () => {
    ...
    expect(state().exameAtual.material).toEqual(material1)
  ...
  it("should return the current exame when calling getExameAtual", () => {
    ...
    expect(state().exameAtual).toBeDefined()
    expect(state().exameAtual.material).toEqual(material1)
  })

  // xit("should update exame fotosEmbalagem when calling onFotosEmbalagem", async () => {
  ...
  //   component.onChangeExameAtual(nrMaterial)
  ...
  // xit("should update exame fotosLacre when calling onFotosLacre", async () => {
  //   expect(component.listaExames.length).toBe(0)
  //   component.listaExames.push(exame)
  //   expect(component.listaExames.length).toBe(1)
  //   populateMaterialFields()
  ...
  // xit("should update exame fotosMaterial when calling onFotosMaterial", async () => {
  //   expect(component.listaExames.length).toBe(0)
  //   component.listaExames.push(exame)
  //   expect(component.listaExames.length).toBe(1)
  //   populateMaterialFields()
  ...
  // xit("should update exame fotosSimCards when calling onFotosSimCards", async () => {
  //   const nrMaterial = "0123/2024"
  //   component.getExame(nrMaterial)
  //   component.onChangeExameAtual(nrMaterial)
  //   const fotos = ["foto1.jpg", "foto2.jpg"]
  ...
  // xit("should update exame fotosMemoryCard when calling onFotosMemoryCard", async () => {
  //   const nrMaterial = "0123/2024"
  //   component.getExame(nrMaterial)
  //   component.onChangeExameAtual(nrMaterial)
  //   const fotos = ["foto1.jpg", "foto2.jpg"]
  ...
  // xit("should return an array of AbstractControl when calling getNrMateriaisControls", () => {
  ...
  // xit("should initialize the material flow", () => {
  //   expect(component.listaExames.length).toBe(0)
  //   component.listaExames.push(exame)
  //   expect(component.listaExames.length).toBe(1)
  //   populateMaterialFields()
  ...
  //   const exameAtual = component.getExameAtual()
  //   expect(component.exameAtual).toBe("0123/2024")
  //   component.listaExames.forEach((exame) => {
  //     if (exame.embalagem === exameAtual.embalagem) {
  ...
  // xit("should update currentStep after RECEBER_MATERIAL", () => {
  //   populateMaterialFields()
  //   expect(component.currentStep()).toBe(STEP.RECEBER_MATERIAL)
  ...
  // xit("should update currentStep after VERIFICAR_MATERIAL_LACRADO", () => {
  //   populateMaterialFields()
  //   component.receberMaterial()
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_MATERIAL_LACRADO)
  ...
  // xit("should update currentStep after VERIFICAR_MATERIAL_DEVE_SER_LACRADO", () => {
  //   populateMaterialFields()
  //   component.materialRecebidoLacrado(false)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_MATERIAL_DEVE_SER_LACRADO)
  ...
  // xit("should update currentStep after VERIFICAR_LACRE_CONFERE", () => {
  //   populateMaterialFields()
  //   component.materialRecebidoLacrado(true)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_LACRE_CONFERE)
  ...
  // xit("should update currentStep after VERIFICAR_QTDE_SIM_CARDS", () => {
  //   populateMaterialFields()
  //   component.registrarLacreConfere(true)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_QTDE_SIM_CARDS)
  ...
  // xit("should update currentStep after VERIFICAR_QTDE_MEMORY_CARDS", () => {
  //   populateMaterialFields()
  //   component.registrarQtdeSimCards(1)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_QTDE_MEMORY_CARDS)
  ...
  // xit("should update currentStep after VERIFICAR_APARELHO_RECEBIDO_LIGADO", () => {
  //   populateMaterialFields()
  //   component.registrarQtdeMemoryCards(0)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_APARELHO_RECEBIDO_LIGADO)
  ...
  // xit("should update currentStep after VERIFICAR_FUNCIONAMENTO_TELA", () => {
  //   populateMaterialFields()
  //   component.registrarAparelhoRecebidoLigado(true)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_FUNCIONAMENTO_TELA)
  ...
  // xit("should update currentStep after VERIFICAR_TELEFONE_BLOQUEADO", () => {
  //   populateMaterialFields()
  //   component.registrarFuncionamentoTela(true)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_TELEFONE_BLOQUEADO)
  ...
  // xit("should update currentStep after VERIFICAR_FORNECIMENTO_SENHA", () => {
  //   populateMaterialFields()
  //   component.registrarTelefoneBloqueado(true)
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_FORNECIMENTO_SENHA)
  ...
  // xit("should update currentStep after VERIFICAR_MODO_AVIAO", () => {
  //   populateMaterialFields()
  //   component.registrarSenhaFornecida(true, "senha")
  //   expect(component.currentStep()).toBe(STEP.VERIFICAR_MODO_AVIAO)
  ...
  // // RECEBER_MATERIAL = 0,
  // // CONFERIR_LACRE = 1
  // xit("should update tarefas after RECEBER_MATERIAL", () => {
  //   expect(component.listaExames.length).toBe(0)
  //   component.listaExames.push(exame)
  //   expect(component.listaExames.length).toBe(1)
  //   populateMaterialFields()
  ...
  // xit("should update tarefas after VERIFICAR_LACRE_CONFERE", () => {
  //   expect(component.listaExames.length).toBe(0)
  //   component.listaExames.push(exame)
  //   expect(component.listaExames.length).toBe(1)
  //   populateMaterialFields()
  ...
  // xit("should update tarefas after REGISTRAR_QTDE_SIM_CARDS", () => {
  //   populateMaterialFields()
  //   component.receberMaterial()
  //   component.registrarLacreConfere(true)
  ...
  // xit("should update tarefas after REGISTRAR_QTDE_MEMORY_CARDS", () => {
  //   populateMaterialFields()
  //   component.receberMaterial()
  //   component.registrarLacreConfere(true)
  //   component.registrarQtdeSimCards(2)
  ...
  // xit("should update tarefas after REGISTRAR_APARELHO_RECEBIDO_LIGADO", () => {
  //   populateMaterialFields()
  //   component.receberMaterial()
  //   component.registrarLacreConfere(true)
  //   component.registrarQtdeSimCards(2)
  ...
  // xit("should update tarefas after REGISTRAR_FUNCIONAMENTO_TELA", () => {
  //   populateMaterialFields()
  //   component.receberMaterial()
  //   component.registrarLacreConfere(true)
  //   component.registrarQtdeSimCards(2)
  ...
  // xit("should update tarefas after REGISTRAR_APARELHO_BLOQUEADO", () => {
  //   populateMaterialFields()
  //   component.receberMaterial()
  //   component.registrarLacreConfere(true)
  //   component.registrarQtdeSimCards(2)
  ...
  // xit("should update tarefas after REGISTRAR_APARELHO_RECEBIDO_MODO_AVIAO", () => {
  //   populateMaterialFields()
  //   component.receberMaterial()
  //   component.registrarLacreConfere(true)
  //   component.registrarQtdeSimCards(2)
